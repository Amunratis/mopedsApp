...
public class Moped2RecyclerAdapter extends RealmRecyclerViewAdapter<Item, Moped2RecyclerAdapter.MyViewHolder> {

    public Moped2RecyclerAdapter(OrderedRealmCollection<Item> data) {
        super(data, true);
    }
